{{-- ============================================================
     ROLE CREATE  →  resources/views/admin/roles/create.blade.php
     ============================================================ --}}
...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0"><i class="fas fa-plus-circle mr-2 text-warning"></i>Create Role</h1>
      </div>
      <div class="col-sm-6">
...
{{-- ============================================================
     ROLE EDIT  →  resources/views/admin/roles/edit.blade.php
     (Save this as a separate file — shown here for reference)
     ============================================================ --}}
{{--
@extends('admin.layouts.app')
    ...
    <form action="{{ route('roles.update', $role->id) }}" method="POST">
      ...
      <div class="card card-outline card-warning shadow-sm">
        <div class="card-header">
          <h3 class="card-title"><i class="fas fa-tag mr-2"></i>Role Info</h3>
          <div class="card-tools">
            <span class="badge badge-warning mr-2"><i class="fas fa-shield-alt mr-1"></i>{{ $role->name }}</span>
            <a href="{{ route('roles.index') }}" class="btn btn-default btn-sm">
              <i class="fas fa-arrow-left mr-1"></i>Back
            </a>
          </div>
      ...
      <div class="card card-outline card-warning shadow-sm">
                ...
                <div class="col-md-4 col-sm-6 mb-4">
                  <div class="card card-outline card-primary mb-0 shadow-none">
                    <div class="card-header p-2">
                      <h6 class="card-title mb-0 d-flex align-items-center justify-content-between">
                        <span>
                          <i class="fas fa-layer-group mr-1 text-primary"></i>{{ $group }}
                          <span class="badge badge-light ml-1">{{ $perms->count() }}</span>
                          @if($groupAssigned > 0)
        ...
        <div class="card-footer">
          ...
          <a href="{{ route('roles.index') }}" class="btn btn-default ml-2"><i class="fas fa-times mr-1"></i>Cancel</a>
        </div>
      </div>
