      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">
            ...
            <span class="badge badge-success ml-1" id="assignedBadge">
              {{ count($assignedIds) }} assigned
            </span>
          </h3>
          <div class="card-tools">
        ...
        <div class="card-body">
          ...
          @if($permissions->isNotEmpty())
            <div class="row">
              ...
              @php
                $groupAssigned = $perms->whereIn('id', $assignedIds)->count();
              @endphp
...
// Live update on individual checkbox change
document.addEventListener('change', function (e) {
  if (e.target && e.target.classList.contains('perm-chk')) {
    updateAssignedBadge();
    // Sync group toggle label
