...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0"><i class="fas fa-plus-circle mr-2 text-success"></i>Add Credit</h1>
      </div>
      <div class="col-sm-6">
          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              ...
              <textarea class="form-control @error('description') is-invalid @enderror"
                        ...
                        rows="4"
                        placeholder="Add a short description of the credit, income source, or purpose.">{{ old('description') }}</textarea>
