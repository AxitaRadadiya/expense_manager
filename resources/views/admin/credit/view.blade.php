...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0"><i class="fas fa-coins mr-2 text-success"></i>Credit Details</h1>
      </div>
      <div class="col-sm-6">
    ...
    <div class="card card-outline card-success shadow-sm">
      <div class="card-header">
        ...
        <div class="card-tools">
          <a href="{{ route('credit.edit', $credit->id) }}" class="btn btn-info btn-sm">
            <i class="fas fa-edit mr-1"></i>Edit
          </a>
          <a href="{{ route('credit.index') }}" class="btn btn-default btn-sm ml-1">
