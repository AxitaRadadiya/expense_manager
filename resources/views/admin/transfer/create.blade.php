...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0"><i class="fas fa-plus-circle mr-2 text-primary"></i>Add Transfer</h1>
      </div>
      <div class="col-sm-6">
        ...
        <div class="card card-outline card-primary shadow-sm">
          <div class="card-header">
            ...
            <div class="card-tools">
              <a href="{{ route('transfer.index') }}" class="btn btn-default btn-sm">
          ...
          <div class="card-footer">
            <button class="btn btn-primary"><i class="fas fa-save mr-1"></i>Create Transfer</button>
            <a href="{{ route('transfer.index') }}" class="btn btn-default ml-2">
