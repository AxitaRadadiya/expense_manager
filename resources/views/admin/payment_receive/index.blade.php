    ...
    <div class="card card-outline card-primary shadow-sm">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center mb-2">
                ...
                <div id="filters-paymentsreceive-panel" style="display:none;">
                        <input type="date" id="filter-paymentsreceive-from" class="form-control">
                        <input type="date" id="filter-paymentsreceive-to" class="form-control">
                    </div>
