...
<div class="content-header">
    <div class="container-fluid-80">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0"><i class="mr-2 text-teal"></i>Add Invoice</h1>
            </div>
            <div class="col-sm-6">
...
<div class="container-fluid-80">
    <div class="card card-outline card-primary shadow-sm">
        <div class="card-header">
            <h3 class="card-title"><i class="fas fa-file-invoice-dollar mr-2"></i>New Invoice</h3>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="sub_category_id" class="form-control select2" required>
                                ...
                                <option value="{{ $s->id }}" {{ old('sub_category_id')==$s->id? 'selected':'' }}>{{ $s->name }}</option>
                                @endforeach
                            </select>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="date" name="invoice_date" class="form-control" min="{{ date('Y-m-d') }}" value="{{ old('invoice_date', date('Y-m-d')) }}" required>
